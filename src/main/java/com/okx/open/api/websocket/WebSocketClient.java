...
public class WebSocketClient implements WebSocket {
	...
	private String stringUrl = "wss://okxcomreal.bafang.com:8443/ws/v3";
	...
	private void init() {
		try {
			...
			WebSocketClientHandshaker shaker = WebSocketClientHandshakerFactory.newHandshaker(uri, WebSocketVersion.V13,
	...
	public void login(String apiKey, String apiSecret, String passphrase) {
		...
		builder.append("{\"args\":[\"" + apiKey + "\",\"" + passphrase + "\",\"" + timeStamp + "\",\"" + hash
				+ "\"],\"op\":\"login\"}");
