package com.okex.open.api.service.publics.data.impl;

import com.alibaba.fastjson.JSONObject;
import com.okex.open.api.client.ApiClient;
import com.okex.open.api.config.ApiConfiguration;
import com.okex.open.api.service.publics.data.PublicDataApiService;
...
public class PublicDataApiServiceImpl implements PublicDataApiService {
	 ...
	 */
	@Override
	public JSONObject getDeliveryExerciseHistory(String instType, String uly, String after, String before,
			String limit) {
	 ...
	 */
	@Override
	public JSONObject getLiquidationOrders(String instType, String mgnMode, String instId, String ccy, String uly,
			String alias, String state, String before, String after, String limit) {
		return this.client.executeSync(
				this.api.getLiquidationOrders(instType, mgnMode, instId, ccy, uly, alias, state, before, after, limit));
	}
